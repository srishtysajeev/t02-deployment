...
# to work with the t02 IOCs and Services.
...
echo "Loading environment for t02 deployment ..."

#### SECTION 1. Environment variables ##########################################

export EC_CLI_BACKEND="ARGOCD"
# the argocd project and root app
export EC_TARGET=zsw36318/t02
# the git repo for this project
export EC_SERVICES_REPO=https://github.com/srishtysajeev/t02-services
